        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/img1.jpg" class="gallery-popup">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/img3.jpg" class="gallery-popup">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/img4.jpg" class="gallery-popup">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/img5.jpg" class="gallery-popup">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="img/gallery/img6.jpg" class="gallery-popup">
