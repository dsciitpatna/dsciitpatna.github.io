  ...
  ============================-->
    ...
    <section id="team" class="team-area">
        <div class="container">
            ...
            <div class="row team-items d-flex justify-content-center">
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/vatsal.jpg" alt="Thumb">
                            <div class="overlay">
              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="site-heading text-center">
                        <h2>Technical <span>Leads</span></h2>
                        <h4></h4>
                    </div>
                </div>
            </div>
              ...
              <div class="row team-items d-flex justify-content-center">
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/piyush.jpg" alt="Thumb">
                            <div class="overlay">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/shivansh.jpg" alt="Thumb">
                            <div class="overlay">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="site-heading text-center">
                        <h2>Innovation MPR <span>and Design Lead</span></h2>
                        <h4></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row team-items d-flex justify-content-center">
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/mayank.jpg" alt="Thumb">
                            <div class="overlay">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/akshat.jpg" alt="Thumb">
                            <div class="overlay">
                                <h4>Akshat Jain</h4>
                               <!-- <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/amish (2).jpg" alt="Thumb">
                            <div class="overlay">
                                <h4> Amish Mittal</h4>
                             <!--   <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="site-heading text-center">
                        <h2>Department <span>Leads</span></h2>
                        <h4></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row team-items d-flex justify-content-center">
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/harsh.jpg" alt="Thumb">
                            <div class="overlay">
                                <h4>Harsh Jindal</h4>
                               <!-- <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/amartya (2).jpg" alt="Thumb">
                            <div class="overlay">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/anubhav.JPG" alt="Thumb">
                            <div class="overlay">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/hitvardhan.jpg" alt="Thumb">
                            <div class="overlay">
                                <h4> Hit Vardhan</h4>
                              <!--  <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/arya.jpg" alt="Thumb">
                            <div class="overlay">
                                <h4> Arya Das</h4>
                             <!--   <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/Deepanjan.jpg" alt="Thumb">
                            <div class="overlay">
            ...
            <div class="row">
                    <div class="col-md-12">
                        <div class="site-heading text-center">
                            <h2>Junior <span>Representatives</span></h2>
                            <h4></h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="row team-items d-flex justify-content-center">
                ...
                <div class="col-md-4 single-item">
                    <div class="item">
                        <div class="thumb">
                            <img class="img-fluid" src="img/team/shreya.png" alt="Thumb">
                            <div class="overlay">
                                <h4>Shreya Sinha </h4>
                              <!--  <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.
